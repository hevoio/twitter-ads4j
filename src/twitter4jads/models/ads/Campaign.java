...
public class Campaign extends TwitterEntity implements Serializable {
    ...
    private String budgetOptimization;
    ...
    public String getBudgetOptimization() {return budgetOptimization; }

    public void setBudgetOptimization(String budgetOptimization) {this.budgetOptimization= budgetOptimization; }
