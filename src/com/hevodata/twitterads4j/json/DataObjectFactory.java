package com.hevodata.twitterads4j.json;
...
public final class DataObjectFactory {
    ...
    static {
        try {
            statusConstructor =
                    (Constructor<Status>) Class.forName("com.hevodata.twitterads4j.internal.json.StatusJSONImpl").getDeclaredConstructor(JSONObject.class);
            statusConstructor.setAccessible(true);

            userConstructor = (Constructor<User>) Class.forName("com.hevodata.twitterads4j.internal.json.UserJSONImpl").getDeclaredConstructor(JSONObject.class);
            ...
            trendConstructor = (Constructor<Trend>) Class.forName("com.hevodata.twitterads4j.internal.json.TrendJSONImpl").getDeclaredConstructor(JSONObject.class);
            ...
            directMessageConstructor = (Constructor<DirectMessage>) Class.forName("com.hevodata.twitterads4j.internal.json.DirectMessageJSONImpl")
                    .getDeclaredConstructor(JSONObject.class);
            directMessageConstructor.setAccessible(true);

            locationConstructor =
                    (Constructor<Location>) Class.forName("com.hevodata.twitterads4j.internal.json.LocationJSONImpl").getDeclaredConstructor(JSONObject.class);
            locationConstructor.setAccessible(true);

            userListConstructor =
                    (Constructor<UserList>) Class.forName("com.hevodata.twitterads4j.internal.json.UserListJSONImpl").getDeclaredConstructor(JSONObject.class);
