...
import com.hevodata.twitterads4j.api.TwitterAdsTargetingApi;
import com.hevodata.twitterads4j.internal.models4j.LocationType;
...
import com.hevodata.twitterads4j.models.ads.tags.TwitterApplicationList;
import com.hevodata.twitterads4j.models.ads.targeting.TargetingParamRequest;
import com.hevodata.twitterads4j.models.ads.targeting.TargetingParamResponse;
import com.hevodata.twitterads4j.models.ads.targeting.TwitterTargetingOperator;
...
import static com.hevodata.twitterads4j.models.ads.TargetingType.*;
import static com.hevodata.twitterads4j.util.TwitterAdUtil.constructBaseAdsListResponse;
...
public class TwitterAdsTargetingApiImpl implements TwitterAdsTargetingApi {
    ...
    public BaseAdsResponse<TargetingCriteria> getTargetingCriteriaById(String accountId, String targetingId, boolean withDeleted)
        ...
        String baseUrl = twitterAdsClient.getBaseAdsAPIUrl() + TwitterAdsConstants.PREFIX_ACCOUNTS_URI + accountId + TwitterAdsConstants.PATH_TARGETING_CRITERIA +
                targetingId;
    ...
    public BaseAdsListResponseIterable<TargetingCriteria> getAllTargetingEvents(String q) throws TwitterException {
        return hitQueryForPath(q, TwitterAdsConstants.PATH_TARGETING_CRITERIA_EVENT);
    }

    @Override
    public BaseAdsListResponseIterable<TargetingCriteria> getAllTargetingInterests(String q) throws TwitterException {
        return hitQueryForPath(q, TwitterAdsConstants.PATH_TARGETING_CRITERIA_INTERESTS);
    }
    ...
    public BaseAdsListResponseIterable<TargetingCriteria> getAllTargetingNetworkOperators(String q) throws TwitterException {
        return hitQueryForPath(q, TwitterAdsConstants.PATH_TARGETING_CRITERIA_NETWORK_OPERATORS);
    }

    @Override
    public BaseAdsListResponseIterable<TargetingCriteria> getAllTargetingLocales(String q) throws TwitterException {
        return hitQueryForPath(q, TwitterAdsConstants.PATH_TARGETING_LANGUAGES);
    }
    ...
    public BaseAdsResponse<NewTwitterReachEstimate> getReachEstimate(String accountId, ProductType productType,
        ...
        params.add(new HttpParameter(TwitterAdsConstants.BID_TYPE, bidType));

        if (!BidType.AUTO.name().equals(bidType)) {
            TwitterAdUtil.ensureNotNull(bidAmountLocalMicro, "Bid Amount Local Micro");
            params.add(new HttpParameter(TwitterAdsConstants.BID_AMOUNT_LOCAL_MICRO, bidAmountLocalMicro));
        }

        final String url = twitterAdsClient.getBaseAdsAPIUrl() + TwitterAdsConstants.PREFIX_ACCOUNTS_URI + accountId + TwitterAdsConstants.PATH_REACH_ESTIMATE;
    ...
    public BaseAdsListResponseIterable<IabCategory> fetchIabCategories(String q) throws TwitterException {
        ...
        final String baseUrl = twitterAdsClient.getBaseAdsAPIUrl() + TwitterAdsConstants.PATH_IAB_CATEGORIES;
    ...
    public TargetingParamResponse createTargetingBatchRequest(String
        ...
        String baseUrl = twitterAdsClient.getBaseAdsAPIUrl() + TwitterAdsConstants.PREFIX_BATCH_ACCOUNTS_URI + TwitterAdsConstants.PATH_ACCOUNTS + accountId + TwitterAdsConstants.PATH_TARGETING_CRITERIA;
    ...
    public BaseAdsListResponseIterable<TargetingCriteria> getAllTargetingTVChannels(String
        ...
        if (TwitterAdUtil.isNotNullOrEmpty(tvMarketLocale)) {
            params.add(new HttpParameter(TwitterAdsConstants.PARAM_TV_MARKET_LOCALE, tvMarketLocale));
        }
        ...
        final String baseUrl = twitterAdsClient.getBaseAdsAPIUrl() + TwitterAdsConstants.PATH_TV_CHANNELS;
    ...
    @Override
    public BaseAdsListResponseIterable<TargetingLocation> getTargetingLocations(String query, com.hevodata.twitterads4j.models.LocationType
            locationType) throws TwitterException {

        List<HttpParameter> params = new ArrayList<>(2);
        if (StringUtils.isNotBlank(query)) {
            params.add(new HttpParameter(TwitterAdsConstants.PARAM_Q, query.trim()));
        }
        params.add(new HttpParameter(TwitterAdsConstants.PARAM_LOCATION_TYPE, locationType.name()));
        String baseUrl = twitterAdsClient.getBaseAdsAPIUrl() + TwitterAdsConstants.PATH_TARGETING_CRITERIA_LOCATION;
        Type type = new TypeToken<BaseAdsListResponse<TargetingLocation>>() {
        }.getType();
    ...
    public BaseAdsListResponseIterable<Conversations> getAllTargetingConversations() throws TwitterException {
        final List<HttpParameter> params = new ArrayList<>();
        final String baseUrl = twitterAdsClient.getBaseAdsAPIUrl() + TwitterAdsConstants.PATH_TARGETING_CRITERIA_CONVERSATIONS;
    ...
    public BaseAdsListResponseIterable<IabCategory> getAllIabCategories(String q) throws TwitterException {
        return hitQueryForPath(q, TwitterAdsConstants.PATH_IAB_CATEGORIES);
    }
    ...
    public BaseAdsListResponseIterable<TargetingCriteria> getAllTVShows(String tvMarket, String q, Optional<Integer> count, Optional<String> cursor) throws TwitterException {
        ...
        String baseUrl = twitterAdsClient.getBaseAdsAPIUrl() + TwitterAdsConstants.PATH_TV_SHOWS;
    ...
    public BaseAdsListResponseIterable<TargetingCriteria> getAllEvents() throws TwitterException {
        final List<HttpParameter> params = new ArrayList<>();
        final String baseUrl = twitterAdsClient.getBaseAdsAPIUrl() + TwitterAdsConstants.PATH_TARGETING_CRITERIA_EVENT;
        final Type type = new TypeToken<BaseAdsListResponse<TargetingCriteria>>() {
        }.getType();
    ...
    public BaseAdsListResponseIterable<TargetingCriteria> getAllTVMarkets() throws TwitterException {
        final List<HttpParameter> params = new ArrayList<>();
        final String baseUrl = twitterAdsClient.getBaseAdsAPIUrl() + TwitterAdsConstants.PATH_TV_MARKETS;
        final Type type = new TypeToken<BaseAdsListResponse<TargetingCriteria>>() {
        }.getType();
    ...
    public BaseAdsListResponseIterable<TargetingCriteria> getAllTargetingTVGenres() throws TwitterException {
        final List<HttpParameter> params = new ArrayList<>();
        final String baseUrl = twitterAdsClient.getBaseAdsAPIUrl() + TwitterAdsConstants.PATH_TV_GENRES;
        final Type type = new TypeToken<BaseAdsListResponse<TargetingCriteria>>() {
        }.getType();
    ...
    public BaseAdsListResponseIterable<TwitterBehavior> getBehaviors(Optional<Integer> count, Optional<String> cursor, List<String> behaviorIds, Optional<String> countryCode) throws TwitterException {
        ...
        final String baseUrl = twitterAdsClient.getBaseAdsAPIUrl() + TwitterAdsConstants.PATH_BEHAVIORS;
    ...
    public BaseAdsListResponseIterable<TwitterBehaviorTaxonomy> getBehaviorTaxonomy(List<String> behaviorTaxonomyIds, List<String> parentBehaviorTaxonomyIds, Optional<Integer> count, Optional<String> cursor) throws TwitterException {
        ...
        if (TwitterAdUtil.isNotEmpty(parentBehaviorTaxonomyIds)) {
            params.add(new HttpParameter(TwitterAdsConstants.PARAM_PARENT_BEHAVIOR_TAXONOMY_IDS, TwitterAdUtil.getCsv(parentBehaviorTaxonomyIds)));
        }
        ...
        final String baseUrl = twitterAdsClient.getBaseAdsAPIUrl() + TwitterAdsConstants.PATH_BEHAVIORS_TAXONOMY;
        ...
        for (Map.Entry<TargetingType, List<String>> entry : targeting.entrySet()) {
            switch (entry.getKey()) {
                case LOCATION:
                    ...
                    params.add(new HttpParameter(TwitterAdsConstants.PARAM_LOCATIONS, TwitterAdUtil.getCsv(entry.getValue())));
                    break;
                ...
                case APP_STORE_CATEGORY:
                    params.add(new HttpParameter(TwitterAdsConstants.PARAM_APP_STORE_CATEGORY, TwitterAdUtil.getCsv(entry.getValue())));
                    break;
            }
        }
        return params;
