...
import com.hevodata.twitterads4j.internal.http.HttpResponseCode;
import com.hevodata.twitterads4j.internal.json.z_T4JInternalJSONImplFactory;
import com.hevodata.twitterads4j.internal.json.z_T4JInternalParseUtil;
...
public class TwitterException extends Exception implements TwitterResponse, HttpResponseCode {
    ...
    private final static String[] FILTER = new String[]{"com/hevodata/twitterads4j"};
