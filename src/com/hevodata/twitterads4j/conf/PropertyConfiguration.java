...
import com.hevodata.twitterads4j.internal.util.z_T4JInternalStringUtil;
...
public final class PropertyConfiguration extends ConfigurationBase implements Serializable {
    ...
    PropertyConfiguration(String treePath) {
        ...
        final String TWITTER4J_PROPERTIES = "twitter4jads.properties";
        // override System properties with ./twitter4jads.properties in the classpath
        loadProperties(props, "." + File.separatorChar + TWITTER4J_PROPERTIES);
        // then, override with /twitter4jads.properties in the classpath
        loadProperties(props, Configuration.class.getResourceAsStream("/" + TWITTER4J_PROPERTIES));
        // then, override with /WEB/INF/twitter4jads.properties in the classpath
     ...
     * 1. load [twitter4jads.]restBaseURL<br>
     * 2. override the value with foo.[twitter4jads.]restBaseURL<br>
     * 3. override the value with foo.bar.[twitter4jads.]restBaseURL<br>
     *
